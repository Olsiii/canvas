...
- `pnpm check` green; `pnpm db:generate` shows no drift after the migration; `pnpm db:migrate` applied locally this time *before* running Playwright (M4.3 caught this exact gap once already — see above).
